...
<html>
	...
	<body>
		<div id="civitas-resume-container" class="container">
			<div id="civitas-resume-name">' . $user->firstName . ' ' . $user->lastName . '</div>
			<div id="civitas-resume-contactinfo">' . 'Email: ' . $user->emailAddress. '</div>
			<div id="civitas-resume-summary">' . $user->summary . '</div>
